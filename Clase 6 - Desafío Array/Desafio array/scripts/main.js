...
class ProcesoElectoral {
  ...
  presupuestoElecciones() {
    return (
      this.presupuestoPrevio + this.presupuestoActual + this.presupuestoPartidos
    );
  }
...
console.log(
  `Número de Procesos Electorales analizados: ${procesosElectorales.length}`
);
console.log(
  `Procesos Electorales analizados: ${procesosElectorales.toString()}`
);
...
let fecha = prompt(
  `Ingresa el año de la elección en Argentina:\n\n Opciones válidas: ${procesosElectorales.join(
    "-"
  )}`
);
...
while (fecha != "ESC") {
  if (fecha == procesosElectorales[0]) {
    alert(
      `Con una participación ciudadana de ${procesoElectoral2015.participacion()}% en la elección de ${fecha}, el costo de cada voto fue de ${procesoElectoral2015.costoVoto()} pesos. `
    );
    fecha = prompt(
      `Ingresa el año de la elección en Argentina:\n\n Opciones válidas: ${procesosElectorales.join(
        "-"
    ...
    alert(
      `Con una participación ciudadana de ${procesoElectoral2018.participacion()}% en la elección de ${fecha}, el costo de cada voto fue de ${procesoElectoral2018.costoVoto()} pesos. `
    );
    fecha = prompt(
      `Ingresa el año de la elección en Argentina:\n\n Opciones válidas: ${procesosElectorales.join(
        "-"
    ...
    alert(
      `Con una participación ciudadana de ${procesoElectoral2021.participacion()}% en la elección de ${fecha}, el costo de cada voto fue de ${procesoElectoral2021.costoVoto()} pesos. `
    );
    fecha = prompt(
      `Ingresa el año de la elección en Argentina:\n\n Opciones válidas: ${procesosElectorales.join(
        "-"
